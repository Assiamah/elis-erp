    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="">cst Supervisor Management</a>
        </li>
...
<!--          </div> -->
          ...
          <div class="row">
            ...
            <div class="col mb-4">
              <div class="card border-left-primary shadow h-100 py-2"  id="body-dg-1">
                <div class="card-body">
                <a href="#"  class="text-decoration-none btnLoadSupervisor_applicstions_cst" data-id="1">
            ...
            <div class="col mb-4">
              <div class="card border-left-success shadow h-100 py-2"  id="body-dg-2">
                <div class="card-body">
                 <a href="#"  class="text-decoration-none btnLoadSupervisor_applicstions_cst" data-id="2">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
            ...
            <div class="col mb-4">
              <div class="card border-left-info shadow h-100 py-2"  id="body-dg-3">
                <div class="card-body">
                <a href="#"  class="text-decoration-none btnLoadSupervisor_applicstions_cst" data-id="3"> 
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
            ...
            <!-- Pending Requests Card Example -->
             <div class="col-xl-3 col-md-6 mb-4" >
              <div class="card border-left-warning shadow h-100 py-2" id="body-dg-4">
                <div class="card-body" >
                <a href="#"  class="text-decoration-none btnLoadSupervisor_applicstions_cst" data-id="4">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
     ...
     <div class="col-lg-12">
          ...
          <div class="card mb-3">
           ...
           <table class="table table-bordered table-hover" id="job_casemgtdetailsdataTable__supervisor_cst" width="100%" cellspacing="0">
