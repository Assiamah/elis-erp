	        ...
	        <div class="col">
	          ...
	          <div class="card mb-3">
	            <div class="card-header">
	              <i class="fa fa-bar-chart"></i>Manage Applications Checklist</div>
	            <div class="card-body">
    ...
    <div class="row">
     <div class="col-lg-12">
          ...
          <div class="card mb-3" id="milestones-search-results-section">
            <div class="card-header">
              <i class="fa fa-bar-chart"></i>Checklist  Results</div>
            <div class="card-body">
	...
	<div class="modal-dialog ">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="edit_add_checklist">
					<input type="hidden" id="chk_id" value=0/>
					
					<div class="container">	
	
								<div class="form-group">
									<label for="mt_to" class="col-form-label">Checklist Description :</label> 
									<textarea class="form-control" id="chk_description" required></textarea>
								</div>
														
								<div class="form-group">
											<label for="mt_to" class="col-form-label">Option</label> 
											<!-- <input class="form-control" id="mile_stone_option" required> -->
											 <select class="form-control" id="chk_option" required>
								...
								<div class="form-group">
									...
									<input type="number" step=1 min=1 class="form-control" id="chk_priority_value" required>
