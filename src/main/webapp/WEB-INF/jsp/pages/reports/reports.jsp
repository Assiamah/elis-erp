          ...
          <div id="accordion" role="tablist" aria-multiselectable="true">
           ...
           <table class="table table-bordered table-hover datatable" id="job_casemgtdetailsdataTable_elis_reports" width="100%" cellspacing="0">
		    ...
		    <div class="card">
		        <h5 class="card-header" role="tab" id="headingThree">
		            <a class="collapsed d-block" data-toggle="collapse" data-parent="#accordion" href="#collapseparties" aria-expanded="false" aria-controls="collapseFive">
		                <i class="fa fa-chevron-down pull-right"></i> <i class="fa fa-cube"></i>Audit Report
		            </a>
		        </h5>
		        <div id="collapseparties" class="collapse show" role="tabpanel" aria-labelledby="headingThree">
		            <div class="card-body">
		                
		                    <button type="button" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" id="btn_generate_details_based_on_users_audit" data-placement="top" data-toggle="tooltip" title="Search"><i class="fas fa-download fa-sm text-white-50"></i>View Report</button>
                  
                 <button type="button" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" id="btn_generate_details_based_on_users_csv_audit" data-placement="top" data-toggle="tooltip" title="Search"><i class="fas fa-download fa-sm text-white-50"></i>Download Report</button>
                  <br/>
		                            <div class="table-responsive">
           <table class="table table-bordered table-hover datatable" id="job_casemgtdetailsdataTable_elis_reports_audit" width="100%" cellspacing="0">
			<thead>
                <tr>
              <!--    <th style="">&nbsp;</th>
                 <th><input type="checkbox" id="selectAll"/></th> -->
        ...
        <div class="col-xl-3 col-md-6 mb-4">
          <div class="card border-left-warning shadow h-100 py-2">
              <div class="card-body">
                  <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                          <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Keep In View Applications
                          </div>
                          <div class="row no-gutters align-items-center">
                              <div class="col-auto">
                                  <div id="app-kiv" class="h5 mb-0 mr-3 font-weight-bold text-gray-800">0</div>
                              </div>
