                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <button type="button" class="btn btn-outline-danger btn-sm w-100 mt-2" id="lrd_btn_refresh_btn_wkt" data-bs-tooltip="tooltip" title="Refresh">
                        ...
                        <div class="card border-success mb-4">
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="row g-2 mt-2">
                                    <div class="col-8">
                                        <input type="text" class="form-control form-control-sm" id="lrd_search_smd_by_text" placeholder="Search SMD Records by Ref">
                                    </div>
                                    <div class="col-4">
                                        <button class="btn btn-warning btn-sm w-100" id="lrd_btn_search_smd_dat_by_ref" title="Search SMD">
                                            <i class="fas fa-database"></i> SMD
                                        </button>
                                    </div>
                                </div>
                                <div class="row g-2 mt-2">
                                    <div class="col-8">
                                        <input type="text" class="form-control form-control-sm" id="lrd_search_by_reference" placeholder="Search by Reference Number">
                                    </div>
                                    <div class="col-4">
                                        <button class="btn btn-primary btn-sm w-100" id="lrd_btn_search_by_reference_number" title="Search by Reference">
                                            <i class="fas fa-search"></i> Ref
                                        </button>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card border-warning mb-4">
                            ...
                            <div class="card-body p-3">
                                ...
                                <div class="d-flex gap-2 mt-2">
                                    <button class="btn btn-info btn-sm flex-fill" id="lrd_btn_load_for_scanned_maps_by_point">
                                        <i class="fas fa-map-pin me-1"></i> Load by Point
                                    </button>
                                </div>
                            </div>
                        </div>
...
<!-- OpenLayers and other dependencies -->
<script src="${pageContext.request.contextPath}/js-pages/gated_workflow.js"></script>
<script src="${pageContext.request.contextPath}/js-pages/lrdmaps.js"></script>
