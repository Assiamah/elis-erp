    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="index.jsp">Generation of LS AND Deed Numbers</a>
        </li>
        <li class="breadcrumb-item active">Process batch List</li>
				               ...
				               <div class="form-group">
								...
								<input placeholder="Job Number" id="txt_gld_job_number_search_plan" class="form-control input-sm" data-style="btn-info" type="text" />
							...
							<div class="form-group">
								<div class="form-row">
									<div class="col">
										<button class="btn btn-secondary btn-icon-split float-left " id="btn_gld_job_number_search_plan" data-backdrop="static" data-keyboard="false" >
     ...
     <div class="col-lg-12">
          ...
          <div class="card mb-3">
           ...
           <table class="table table-bordered data-table" id="tbl_gld_search_for_job_details_datatable" width="100%" cellspacing="0">
                ...
                <tr ${appfiles.objections > 0 ? "class='bg-danger text-white red-tooltip' title='Application has pending Objections'  data-toggle='tooltip' data-placement='left' ":""}>
                    ...
                    <td>
                    	<button 
                    		...
                    		data-target="#frmlrdgeneratelsnumberdeedsmodal" data-toggle="modal" >
