    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="index.jsp">LRD Transaction Template</a>
        </li>
        <li class="breadcrumb-item active">Search for Transaction</li>
      </ol>
      
      
      <!-- 	<button type="button" class="btn btn-success btn-sm" id="btn_open_lrd_transaction_short"
       ...
       -->
          ...
          <div class="row">
			          ...
			          <!-- <div class="col-md-2">
			                <div class="form-group">
			                 <button type="button" class="btn btn-primary" id="lrd_btn_search_by_certificate_number" data-placement="top" data-toggle="tooltip" title="Show Location"><i class="fa fa-retweet"></i> </button>
			            ...
			            <div class="col-md-2">
			                <div class="form-group">
			                 <button type="button" class="btn btn-primary" id="lrd_btn_search_by_transaction_reference_number" data-placement="top" data-toggle="tooltip" title="Search"><i class="fa fa-search"></i> </button>
