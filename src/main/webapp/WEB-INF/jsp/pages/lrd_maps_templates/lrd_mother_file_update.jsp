    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="index.jsp">Certificate and Register Generation Template</a>
        </li>
          ...
          <div class="card mb-3">
            <div class="card-header bg-dark text-white">
              ...
              <button class="btn btn-success btn-icon-split float-right "  id="btnViewCompetedQueriedList">
					<span class="icon text-white-50"> <i class="fas fa-eye"></i></span><span class="text">View Completed/Queried List</span>
				</button></span>
           ...
           <table class="table table-bordered table-hover data-table" id="job_casemgtdetailsdataTable" width="100%" cellspacing="0">
              ...
              <thead>
               ...
               <!--   <th>Work</th> -->
                ...
                <tr ${appfiles.objections > 0 ? "class='bg-danger text-white red-tooltip' title='Application has pending Objections'  data-toggle='tooltip' data-placement='left' ":""}>
                  ...
                  <td>
                    <form action="certificate_register_progress_details" method="post">
...
<!--           
					 ...
					 <td>
                    	<button 
                    		...
                    		data-business_process_sub_name="${appfiles.business_process_sub_name}" 
                    		data-target="#transitional_certificate_template" data-toggle="modal" >
                    		<span class="icon text-white-50"> <i class="fas fa-list"></i></span>
