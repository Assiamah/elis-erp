...
<%@ page import="org.codehaus.jettison.json.JSONObject" %>
    ...
    <div class="container-fluid">
     ...
     <div class="col-lg-3">
          ...
          <div class="card mb-3">
            ...
            <div class="card-body">
		     ...
		     <div class="btn-group mr-2">
		      <button type="button" class="btn btn-primary" id="lrd_btn_add_coordinate" data-placement="top" data-toggle="tooltip" title="Add Coordinate">
            <i class="fa fa-plus-circle"></i>
        </button>
        
        
		   <button type="button" class="btn btn-primary"  id="btn_visualise_coordinate" data-placement="top" data-toggle="tooltip" title="Visualise Polygon">
            <i class="fa fa-eye"></i>
        </button>
        
		   <button type="button" class="btn btn-primary"  id="btn_visualise_wkt" data-placement="top" data-toggle="tooltip" title="Visualise Polygon">
            <i class="fa fa-map"></i>
        </button>
        
          <button type="button" class="btn btn-primary"  id="btn_visualise_wkt" data-placement="top" data-toggle="tooltip" title="Plot Parcels">
        ...
        <button type="button" class="btn btn-primary" id="btnprintmap" data-placement="top" data-toggle="tooltip" title="Visualise Polygon">
            <i class="fa fa-print"></i>
        </button>
		 
		  
        <button type="button" class="btn btn-primary" id="btn_visualise_search" data-placement="top" data-toggle="tooltip" title="Visualise Search">
            <i class="fa fa-print"></i>
        </button>
		 
		 
		<button type="button" class="btn btn-primary" id="btngeneratesearchreport" data-placement="top" data-toggle="tooltip" title="Print Search Report">
            <i class="fa fa-print"></i>
        </button>
     ...
     <!--  WKT row here -->
        ...
        <textarea rows="2" class="form-control" placeholder="" id="bl_wkt_polygon" value="System Cleanup"></textarea>
        </div>
         </div>
         ...
         <div class="row">
            ...
            <div class="col-md-5">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="name" placeholder="X-Coordinate"> 
                </div>
            </div>
            ...
            <div class="col-md-5">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="name" placeholder="Y-Coordinate"> 
            ...
            <div class="col-md-2">
                <div class="form-group">
                 <button type="button" class="btn btn-primary" id="btn_show_location" data-placement="top" data-toggle="tooltip" title="Show Location"><i class="fa fa-map-marker"></i> </button>
         ...
         <!-- search by reference nunber -->
           ...
           <div class="row">
            ...
            <div class="col-md-10">
			       <div class="btn-group">
			      <input class="form-control" id="pvlmd_saerch_by_text"  name="pvlmd_saerch_by_text"  type="text"  placeholder="Enter Search Text" required >
			    		</div>
            </div>
            ...
            <div class="col-md-2">
                <div class="form-group">
                 <button type="button" class="btn btn-primary" id="btn_show_location" data-placement="top" data-toggle="tooltip" title="Show Location"><i class="fa fa-search"></i> </button>
          ...
          <!--  Scanned Maps -->
			...
			<input class="form-control" id="pvlmd_scale_value"  name="pvlmd_scale_value" type="text" list="cars" class="autocomplat" placeholder="Scanned Maps" />
				<datalist id="cars">
				  <option>Volvo</option>
				  <option>Saab</option>
