	        ...
	        <div class="col-lg-12">
	          ...
	          <div class="card mb-3">
	            <div class="card-header bg-dark text-white">
	              <i class="fa fa-bar-chart"></i>Document Management
				  <!-- <a class="btn btn-danger float-right "
					href="/app_job_request_module">
					<i class="fas fa-arrow-left"></i>Go Back To Request Dashboard</a> -->
				</div>
	            <div class="card-body">
						...
						<div class="col-md-6">
							...
							<!-- <form id=""  method="post"> -->
                              ...
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="rbtn_search_type1" name="rbtn_search_type" class="custom-control-input" value="public_docs" required>
                                <label class="custom-control-label" for="rbtn_search_type1">Public Documents</label>
                              </div>
                              <div class="custom-control custom-radio custom-control-inline">
                                <input type="radio" id="rbtn_search_type2" name="rbtn_search_type" class="custom-control-input" value="case_docs" required>
                                <label class="custom-control-label" for="rbtn_search_type2">Case Documents</label>
                              </div>
								...
								<!-- <label for="">Search Case number</label> -->
								  <div class="form-row">
									...
									<div class="col-md-8">
									  ...
									  <input class="form-control" id="cs_main_case_number"  type="text"  placeholder="Enter case number" required >
									</div>
									<div class="col-md-4">
										
									  <button type="button" class="btn btn-primary btn-block" value="Search" id="btn_new_load_scanned_documents_public" > Search </button>
          ...
          <div class="card mb-3"  id="file-search-results-section">
            <div class="card-header">
                <i class="fa fa-bar-chart"></i>Search Results <span
                    ...
                    <!-- <button class="btn btn-success btn-icon-split float-right "  id="btnViewRequestsList">
                        <span class="icon text-white-50"> <i class="fas fa-eye"></i></span><span class="text">View Prepared List</span>
                    </button> -->
                </span>
            ...
            <div class="card-body">
	             ...
	             <div class="table-responsive" >
			           <table class="table table-bordered " id="lc_public_documents_dataTable" >
			              <thead>
			                <tr>
         ...
         <div class="modal-body">
            <form >
               ...
               <div class="modal-footer">
                  ...
                  <button type="button" id="btn_process_request_list"  class="btn btn-primary" >Process List</button>
               </div>
            </form>
         </div>
      </div>
