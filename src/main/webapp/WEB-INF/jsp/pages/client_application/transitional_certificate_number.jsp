    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="index.jsp">Transitional Certificate Number</a>
        </li>
        <li class="breadcrumb-item active">All applications batched to ${fullname}</li>
				       ...
				       <%--        <div class="form-group">
							...
							<div class="form-group">
								<div class="form-row">
									<div class="col">
										<button class="btn btn-secondary btn-icon-split float-left " id="btn_mecd_job_number_search_plan" data-backdrop="static" data-keyboard="false" >
               ...
               <!--   <th style="display:none">Status</th> -->
                ...
                <%--    <td><form  action="${pageContext.request.contextPath}/registration_application_progress_details" method="post"><input type="hidden" name="case_number" id="case_number" value="${appfiles.case_number}"> <input type="hidden" name="job_number" id="job_number" value="${appfiles.job_number}"><input type="submit" name="save" class="btn btn-info btn-icon-split" value="Work"/></form></td>
                 --%>    
                  ...
                  <td><p data-placement="top" data-toggle="tooltip"><button class="btn btn-danger btn-icon-split float-left" data-toggle="modal" data-target="#frmlrdtitlemecdplanupdatemodal" data-backdrop="static" data-keyboard="false"
                    data-job_number="${appfiles.job_number}" 
                    		data-transaction_number="${appfiles.transaction_number}"
                    		data-case_number="${appfiles.case_number}"
                    		data-business_process_sub_name="${appfiles.business_process_sub_name}"  id="deletedew"><span class="icon text-white-50"> <i class="fas fa-folder-open"></i></span><span class="text">Work</span></button></p> </td>
