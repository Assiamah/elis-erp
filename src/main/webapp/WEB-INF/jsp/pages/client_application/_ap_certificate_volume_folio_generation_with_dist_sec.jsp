							...
							<div class="card mb-3">
							 ...
							 <div class="form-row">
							  ...
							  <div class="form-row">
								...
								<div class="col-md-3">
								  <label for="job_number">Distict Number</label>
								  <input class="form-control" id="txt_new_lc_registration_district_number_tsc"  name="txt_new_lc_registration_district_number_tsc"  type="text" aria-describedby="nameHelp"  value="${registration_section_number}" >
								
								</div>
								 <div class="col-md-3">
								<label for="job_number">Section Number</label>
								 <input class="form-control" id="txt_new_lc_registration_section_number_tsc"  name="txt_new_lc_registration_section_number_tsc"  type="text" aria-describedby="nameHelp"  value="${registration_section_number}" >
							 ...
							 <div class="col-md-3">
								<label for="job_number">.</label>
								 <input type="button" id="lc_btn_generate_certificate_volume_folio_tsc" class="btn btn-primary btn-block to_hide_on_level_1" value="Generate Indices" />  
							  </div>
