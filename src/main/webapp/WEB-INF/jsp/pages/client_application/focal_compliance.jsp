...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Focal Persons Compliance Report
    ...
    <div class="row">
        ...
        <div class="col-xl-3 col-md-6 mb-4" id="apps_received_today">
        ...
        <div class="col-xl-3 col-md-6 mb-4" id="apps_received_this_month">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-info shadow h-100 py-2" id="apps_completed_today_division">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
        ...
        <div class="col-xl-3 col-md-6 mb-4" id="apps_completed_month_division">
        ...
        <div id="app-received-completed-year" class="col-lg-4 mb-4">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    ...
                    <span class="small text-primary"><span class="counttt" id="total_rec_comp_year"></span> Applications
                        <!-- <fmt:formatDate value="${now}" pattern="Y" /> -->
                    </span>
