    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="#">Division Further Entries</a>
        </li>
        <li class="breadcrumb-item active">${division}</li>
         ...
         <%-- <p style ="padding:0 3em"><b>Please Note</b> that there are <b>${applicationlistcount}</b> applications (jobs) in this console.
         ${applicationlistcount > 20 ? "<p style='padding: 0 3em'> Out of this, <b style = 'color:red'>only the first 20</b> are being displayed for your actions. As and when an application is worked on and moved out, another will be added to it." : ""}
     ...
     <div class="col-lg-12">
          ...
          <div class="card mb-3">
            <div class="card-header bg-dark text-white">
              ...
              <button class="btn btn-danger btn-icon-split" id="btn_load_back_office_further_entry">
              	<span class="icon text-white-50"> <i class="fas fa-list"></i></span>
              	<span class="text">Total Application  <span class="badge text-white"> [ ${applicationlistcount} ]</span></span>
              </button> 
              <!-- <button class="btn btn-warning btn-icon-split" id="btn_load_back_office_further_entry">
              	<span class="icon text-white-50"> <i class="fas fa-clock"></i></span>
              	<span class="text">Pending Request  <span class="badge text-danger"> [ ${applicationlistcount} ]</span></span>
              </button> 
              <button class="btn btn-success btn-icon-split" id="btn_load_back_office_further_entry">
              	<span class="icon text-white-50"> <i class="fas fa-check-circle"></i></span>
              	<span class="text">Completed Request  <span class="badge text-danger"> [ ${applicationlistcount} ]</span></span>
              </button>  -->


              <!-- <button class="btn btn-warning btn-icon-split float-right " id="btnViewRequestsList">
                <span class="icon text-white-50"> <i class="fas fa-eye"></i></span><span class="text">View Request List</span>
            </button> -->
              ...
              <button class="btn btn-success btn-icon-split float-right "  id="btnViewBatchlist">
				 ...
				 <!-- <button class="btn btn-primary btn-icon-split float-right "  id="btn_load_back_office_further_entry">
					<span class="icon text-white-50"> <i class="fas fa-eye"></i></span><span class="text">Load All</span>
				</button> -->
				</span>
               ...
               <!--   <th style="display:none">Status</th> -->
                ...
                <tr ${appfiles.objections > 0 ? "class='bg-danger text-white red-tooltip' title='Application has pending Objections'  data-toggle='tooltip' data-placement='left' ":""}>
                   ...
                   <!--  <td>
                      ...
                      <c:if test="${appfiles.business_process_sub_name == 'APPLICATION FOR FIRST REGISTRATION'}">
                        ...
                        <form action="request_application_progress_details" method="post">
                          ...
                          <input type="hidden" name="job_purpose" id="job_purpose" value="Noting of parcels">
                          <input type="hidden" name="business_process_sub_name" id="business_process_sub_name" value="${appfiles.business_process_sub_name}">

                         <div class="text-center"><button type="submit" name="save" class="btn btn-warning btn-icon-split" >

                          <span class="icon text-white-50"> <i class="fas fa-edit"></i></span>
                          <span class="text">Coordinate Entry</span>
                          </button><div></form>
                      </c:if>
                      ...
                      <c:choose>
                        ...
                        <c:when test="${appfiles.business_process_sub_name == 'APPLICATION FOR PART TRANSFER'}">
                          <form action="request_application_progress_details" method="post">
                            <input type="hidden" name="case_number" id="case_number" value="">
                            <input type="hidden" name="transaction_number" id="transaction_number" value="">
                            <input type="hidden" name="job_number" id="job_number" value="${appfiles.job_number}">
                        ...
                        <c:when test="${appfiles.business_process_sub_name == 'APPLICATION FOR WHOLE TRANFER'}">
                          <form action="request_application_progress_details" method="post">
                            <input type="hidden" name="case_number" id="case_number" value="">
                            <input type="hidden" name="transaction_number" id="transaction_number" value="">
                            <input type="hidden" name="job_number" id="job_number" value="${appfiles.job_number}">
