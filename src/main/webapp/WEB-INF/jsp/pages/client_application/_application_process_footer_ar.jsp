    ...
    <!--   Here is the right Table -->
        <div class="col-lg-4">
          ...
          <div id="accordion" role="tablist" aria-multiselectable="true">
		    <div class="card">
		        ...
		        <div id="collapsejobs" class="collapse show" role="tabpanel" aria-labelledby="headingOne">
		            <div class="card-body">
                    	...
                    	<!-- <button><i class="fas fa-refresh"></i>Load</button> -->
			...
			<div class="card">
		        <h5 class="card-header" role="tab" id="headingOne">
		            <a data-toggle="collapse" data-parent="#accordion" href="#collapsemilestone" aria-expanded="true" aria-controls="collapseOne" class="d-block">
		                <i class="fa fa-chevron-down pull-right"></i> <i class="fas fa-list"></i>Milestone
		            </a>
		        </h5>
		
		        <div id="collapsemilestone" class="collapse" role="tabpanel" aria-labelledby="headingOne">
		            <div class="card-body">
		               
						<div class="row">
							<div class="col-md-12">
								<div class="card">
									<div class="card-header h5">Milestones</div>
									<div class="card-body">
										<div class="table-responsive dt-responsive">
										<table id="cabinet-tracking" class="table table-bordered">
											<thead>
												<tr>
													<th>SN</th>
													<th>Milestone</th>
		    ...
		    <div class="card">
		        <h5 class="card-header" role="tab" id="headingThree">
		            <a class="collapsed d-block" data-toggle="collapse" data-parent="#accordion" href="#collapserequests" aria-expanded="false" aria-controls="collapseFive">
		                <i class="fa fa-chevron-down pull-right"></i> <i class="fa fa-envelope"></i>Requests On Application
		            </a>
		        </h5>
		        <div id="collapserequests" class="collapse" role="tabpanel" aria-labelledby="headingThree">
		            <div class="card-body">
		                ...
		                <div  class="table-responsive">
				           <table class="table table-bordered  table-hover table-sm" id="lrd_scanned_documents_dataTable" >
				              ...
				              <thead>
				                ...
				                <tbody>
							        <c:forEach items="${application_requests}" var="application_requests_row">
						                <tr class="${application_requests_row.request_inbox == '3' ? 'bg-success text-white' : 'bg-danger text-white'}">
						                    <td>${application_requests_row.job_purpose}</td>
						                    <td>${application_requests_row.job_recieved_by}</td>
						                    <td>${application_requests_row.created_on}</td>
						                    <!-- <td></td> -->
  ...
  <script>
	...
	window.addEventListener('load', function() {
		//console.log('jkgnfjgv')
								...
								var table_sms = $('#sms-tracking');
								table_sms.find("tbody tr").remove();
								...
								$
										.ajax({
											...
											success : function(
												...
												//  console.log(Object.keys(json_p.milestones).length);
												//  console.log(json_p.application_stage);

												var json_count = Object.keys(json_p.milestones).length;
												...
												$(json_p.milestones)
														.each(
																function(
																	...
																	// console.log("aps:"
																	// +
																	// json_p.application_stage
																	// +1);
																	var int_index = ++index;
																	// if (parseInt(json_p.application_details[0].application_stage_main_step) == parseInt(json_count)) {
																	// 	table
																	...
																	// } else {
																		...
																		if (parseInt(this.priority_value) == parseInt(json_p.application_details[0].application_stage_main_step)){
																			table
																					.append("<tr class='bg-warning text-dark'><td>"
																							+ int_index
																							+ "</td><td>"
																							+ this.milestone_description
																							+ "</td><td>Ongoing</td></tr>");
																		}
																		else if (parseInt(this.priority_value) < parseInt(json_p.application_details[0].application_stage_main_step)) {
																			table
																					.append("<tr class='bg-success text-dark'><td>"
																							+ int_index
																							+ "</td><td>"
