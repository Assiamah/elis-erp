...
<div class="main-content app-content">
    <div class="container-fluid page-container">
        ...
        <input class="form-control" type="hidden" id="lc_fr_bl_wkt_polygon" name="lc_fr_bl_wkt_polygon" value="${fn:escapeXml(parcel_wkt)}">
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="row g-3">
                                        ...
                                        <c:if test="${not empty business_process_sub_name and fn:contains(fn:toLowerCase(business_process_sub_name), 'deed')}">
                                            <div class="col-md-4">
                ...
                <div class="accordion shadow-sm" id="sidebarAccordion">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseMap" class="accordion-collapse collapse show" data-bs-parent="#sidebarAccordion">
                            <div class="accordion-body">
                                <button type="button" id="short-review-load-map" class="btn btn-sm btn-outline-primary mb-3">Load Map</button><span id="short-review-map-status" class="small ms-2" role="status"></span><div id="parcelMap" style="height: 300px;"></div>
                            </div>
                        </div>
                    </div>
                    <!-- Related Jobs -->
                    <div class="accordion-item">
                        ...
                        <div id="collapseJobs" class="accordion-collapse collapse" 
                            ...
                            <div class="accordion-body">
<button type="button" class="btn btn-sm btn-outline-primary mb-3 short-review-load" data-section="jobs" data-panel="collapseJobs">Load</button>
<span class="short-review-status small ms-2" role="status" aria-live="polite"></span>
                                <div  class="table-responsive">
									<table class="table table-bordered table-hover table-sm">
										...
										<tbody><tr><td colspan="2" class="text-muted">Click Load to view this section.</td></tr></tbody>
									</table>
								</div>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseParties" class="accordion-collapse collapse" 
                             data-bs-parent="#sidebarAccordion">
                            <div class="accordion-body">
<button type="button" class="btn btn-sm btn-outline-primary mb-3 short-review-load" data-section="parties" data-panel="collapseParties">Load</button>
<span class="short-review-status small ms-2" role="status" aria-live="polite"></span>
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody><tr><td colspan="4" class="text-muted">Click Load to view this section.</td></tr></tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseBills" class="accordion-collapse collapse" 
                             data-bs-parent="#sidebarAccordion">
                            <div class="accordion-body">
<button type="button" class="btn btn-sm btn-outline-primary mb-3 short-review-load" data-section="payments" data-panel="collapseBills">Load</button>
<span class="short-review-status small ms-2" role="status" aria-live="polite"></span>
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        <thead>
                                        ...
                                        <tbody><tr><td colspan="5" class="text-muted">Click Load to view this section.</td></tr></tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
...
<span class="short-review-status small ms-2" role="status" aria-live="polite"></span>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseRecords" class="accordion-collapse collapse" 
                             data-bs-parent="#sidebarAccordion">
                            <div class="accordion-body">
<button type="button" class="btn btn-sm btn-outline-primary mb-3 short-review-load" data-section="records" data-panel="collapseRecords">Load</button>
<span class="short-review-status small ms-2" role="status" aria-live="polite"></span>
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        <thead>
                        ...
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" 
                                ...
                                <span id="pendingQueriesBadge" 
                                    class="badge ms-2 
                                            ${active_case_queries > 0 ? 'bg-danger' : 'bg-success'}">
                                    ${active_case_queries}
                                </span>
                            </button>
                        </h2>
...
<span class="short-review-status small ms-2" role="status" aria-live="polite"></span>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseEncumbrances" class="accordion-collapse collapse" 
                             data-bs-parent="#sidebarAccordion">
                            <div class="accordion-body">
<button type="button" class="btn btn-sm btn-outline-primary mb-3 short-review-load" data-section="encumbrances" data-panel="collapseEncumbrances">Load</button>
<span class="short-review-status small ms-2" role="status" aria-live="polite"></span>
                                <div class="table-responsive">
                                    <table class="table table-sm table-hover">
                                        <thead>
                                        ...
                                        <tbody><tr><td colspan="6" class="text-muted">Click Load to view this section.</td></tr></tbody>
                                    </table>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseLinkDetails" class="accordion-collapse collapse" 
                             data-bs-parent="#sidebarAccordion">
                            <div class="accordion-body">
<button type="button" class="btn btn-sm btn-outline-primary mb-3 short-review-load" data-section="links" data-panel="collapseLinkDetails">Load</button>
<span class="short-review-status small ms-2" role="status" aria-live="polite"></span>
                                <div class="table-responsive">
                                    <table class="table table-sm table-hover">
                                        <thead>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseObjections" class="accordion-collapse collapse" 
                             data-bs-parent="#sidebarAccordion">
                            <div class="accordion-body">
<button type="button" class="btn btn-sm btn-outline-primary mb-3 short-review-load" data-section="objections" data-panel="collapseObjections">Load</button>
<span class="short-review-status small ms-2" role="status" aria-live="polite"></span>
                                <div class="table-responsive">
                                    <table class="table table-sm table-hover">
                                        <thead>
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseLettersOnCase" class="accordion-collapse collapse" 
                             data-bs-parent="#sidebarAccordion">
                            <div class="accordion-body">
<button type="button" class="btn btn-sm btn-outline-primary mb-3 short-review-load" data-section="letters" data-panel="collapseLettersOnCase">Load</button>
<span class="short-review-status small ms-2" role="status" aria-live="polite"></span>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="d-flex gap-2 mb-3">
                                                ...
                                                <button class="btn btn-sm btn-outline-primary w-100 short-review-load" data-section="letters" data-panel="collapseLettersOnCase">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseCaseSteps" class="accordion-collapse collapse" 
                             data-bs-parent="#sidebarAccordion">
                            <div class="accordion-body"><button type="button" class="btn btn-sm btn-outline-primary mb-3 short-review-load" data-section="workflow" data-panel="collapseCaseSteps">Load</button>
<span class="short-review-status small ms-2" role="status" aria-live="polite"></span>
<div class="short-review-results"><p class="text-muted">Click Load to view case steps.</p></div>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    ...
    function initializeShortReviewMap() {
...
var undergoing_registration_status_dataLayer = new ol.layer.Tile({
	...
	source : undergoing_registration_status_dataSource
        ...
        const wktPolygon = document.getElementById('lc_fr_bl_wkt_polygon').value;
        if (!wktPolygon.trim()) { throw new Error('No parcel geometry is available.'); }
        const parcelFeatures = (new ol.format.WKT()).readFeatures(wktPolygon);
        if (!parcelFeatures.length) { throw new Error('No parcel geometry is available.'); }
        ...
        //   vectorLayer.setSource(new ol.source.Vector({features : parcelFeatures}));
