    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="">Corpoorate FRRV/CST Coordinator Management</a>
        </li>
          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-md-6 mb-4">
              <div class="card border-left-primary shadow h-100 py-2"  id="body-dg-1">
                <div class="card-body">
                <a href="#"  class="text-decoration-none btnLoadUnitApplicationsfrrvcst" data-id="1">
            ...
            <div class="col-xl-2 col-md-6 mb-4">
              <div class="card border-left-success shadow h-100 py-2"  id="body-dg-2">
                <div class="card-body">
                 <a href="#"  class="text-decoration-none btnLoadUnitApplicationsfrrvcst" data-id="3">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
            ...
            <div class="col-xl-2 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2"  id="body-dg-3">
                <div class="card-body">
                <a href="#"  class="text-decoration-none btnLoadUnitApplicationsfrrvcst" data-id="awaiting"> 
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
            ...
            <div class="col-xl-2 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2"  id="body-dg-4">
                <div class="card-body">
                <a href="#"  class="text-decoration-none btnLoadUnitApplicationsfrrvcst" data-id="awaiting_smd"> 
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
            ...
            <div class="col-xl-2 col-md-6 mb-4">
              <div class="card border-left-info shadow h-100 py-2"  id="body-dg-5">
                <div class="card-body">
                <a href="#"  class="text-decoration-none btnLoadUnitApplicationsfrrvcst" data-id="awaiting_lrd"> 
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
            ...
            <div class="col-xl-2 col-md-6 mb-4" >
              <div class="card border-left-warning shadow h-100 py-2" id="body-dg-6">
                <div class="card-body" >
                <a href="#"  class="text-decoration-none btnLoadUnitApplicationsfrrvcst" data-id="awaiting_pvlmd">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
          ...
          <div class="card mb-3">
              <div class="card-header bg-dark text-white d-flex">
                ...
                <div class="ml-auto p-2 ">
                  <button class="btn btn-success btn-icon-split show-for-tab-2" style="display:none" id="btnViewBatchlist" style="display:none">
                    <span class="icon text-white-50"> <i class="fas fa-eye"></i></span><span class="text">View Batch List</span>
                  </button>
                  <button class="btn btn-warning btn-icon-split show-for-tab-2" style="display:none" data-toggle="modal" data-target="#update_application_status_frrv_cst_modal">
                    <span class="icon text-white-50"> <i class="fas fa-clock"></i></span><span class="text">Update Application Status</span>
                  </button>
                </div>
          <!-- <span class="col-md-3 float-right show-for-tab-2" style="display:none" data-title="modal" data-target="#update_application_status_modal">
            </span> -->
           ...
           <div class="row">
                ...
                <div class="form-group show-for-tab-2 col-sm-4" style="display:none">
                  ...
                  <div class="form-row mt-2">
	            	...
	            	<label for="search_btn">&nbsp;</label> 
	            		<button class="btn btn-primary btn-icon-split"  id="btnSendAllForfrrvcst">
	            	...
	            	<div class="col-sm-4 float-right  show-for-tab-2" style="display:none">
	            	<label for="search_btn">&nbsp;</label> 
	            		<button class="btn btn-danger btn-icon-split"  id="btnAddAlltofinishedList_frrv_cst">
							<span class="icon text-white-50"> <i class="fas fa-plus"></i></span><span class="text">Finish FRRV/CST Step for Selected</span>
						</button>
	            	</div>
            	</div>
            	<div class="col-sm-6">
           ...
           <table class="table table-bordered table-hover" id="job_casemgtdetailsdataTable_frrv_cst" width="100%" cellspacing="0">
