    ...
    <div class="container-fluid page-container">
        ...
        <div class="page-header-breadcrumb mb-4">
            <div class="d-flex align-center justify-content-between flex-wrap">
                <div>
                    <h1 class="page-title fw-medium fs-18 mb-1">Digital Map Searches</h1>
                    <p class="text-muted small mb-0">
                        <i class="ri-information-line me-1"></i>Search, inspect, and plot digital map records
                    </p>
                </div>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="javascript:void(0);" class="text-dark">ELIS</a></li>
                    <li class="breadcrumb-item"><a href="javascript:void(0);" class="text-dark">Digital Search</a></li>
                ...
                <div class="card shadow-sm border-0 mb-4">
                    ...
                    <div class="card-body">
                        <div class="btn-group w-100 mb-4">
                            <button type="button" class="btn btn-primary btn-sm" id="pvlmd_btn_add_coordinate" data-bs-toggle="modal" data-bs-target="#addcoordinatetoplot" data-bs-tooltip="tooltip" title="Draw a Line">
                    ...
                    <div class="card-footer bg-transparent border-0 pt-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="text-muted small">
                                <i class="fas fa-info-circle me-1"></i> PVLMD map search workspace
                            </div>
                            <div class="text-muted small">
