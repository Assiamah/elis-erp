    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Search for Transaction</li>
      	...
      	<button type="button" class="btn btn-success btn-sm" id="btn_open_pvlmd_transaction_short"
									
								>Add New Short Transaction</button>
								
								
								<button type="button" class="btn btn-primary btn-sm" id="btn_open_pvlmd_transaction_long"
          ...
          <div class="row">
			          ...
			          <!-- <div class="col-md-2">
			            ...
			            <div class="col-md-2">
			                <div class="form-group">
			                 <button type="button" class="btn btn-primary" id="pvlmd_btn_search_by_transaction_reference_number_add" data-placement="top" data-toggle="tooltip" title="Search"><i class="fa fa-search"></i> </button>
