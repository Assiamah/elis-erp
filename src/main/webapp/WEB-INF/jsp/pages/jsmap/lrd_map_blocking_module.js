$(document)
		.ready(
				function() {
					var lrd_block_point_coordinate_list;

					var lrd_block_click_type = 'MapClick';
					...
					var lrd_block_lrd_parcels_dataLayer = new ol.layer.Tile({
						title : 'LRD Parcels',
						source : lrd_block_parcel_lrd_dataSource

					})

					var lrd_block_spatial_blocked_dataSource = new ol.source.TileWMS(
							{
					...
					var lrd_block_spatial_blocked_dataLayer = new ol.layer.Tile({
						title : 'LRD Blocked Parcel',
						source : lrd_block_spatial_blocked_dataSource

					})


					var lrd_block_spatial_deleted_dataSource = new ol.source.TileWMS(
						{
				...
				var lrd_block_spatial_deleted_dataLayer = new ol.layer.Tile({
					title : 'LRD Deleted Parcel',
					visible : false,
					source : lrd_block_spatial_deleted_dataSource

				})

					var lrd_block_grid_lrd_dataSource = new ol.source.TileWMS(
							{
					...
					var lrd_block_grid_lrd_dataLayer = new ol.layer.Tile({
						title : 'LRD Grid',
						visible : false,
						source : lrd_block_grid_lrd_dataSource

					})

					var lrd_block_registration_district_dataSource = new ol.source.TileWMS(
							{
								url : getGeoServerEndPoint() + '/geoserver/csau_geospatial/wms',
								params : {
					...
					var lrd_block_registration_district_dataLayer = new ol.layer.Tile(
							{
								title : 'Registration District',
								visible : false,
								source : lrd_block_registration_district_dataSource

							})

					var smd_block_smd_current_dataSource = new ol.source.TileWMS(
							{
								url : getGeoServerEndPoint() + '/geoserver/csau_geospatial/wms',
								params : {
					...
					var smd_block_smd_current_dataLayer = new ol.layer.Tile({
						title : 'SMD Current Layer',
						visible : false,
						source : smd_block_smd_current_dataSource
					...
					var lrd_block_StaticImage = new ol.layer.Image({
						title : 'Scanned Map',
					...
					lrd_block_pvlmd_searchLayer = new ol.layer.Vector({
						title : 'Search Layer',
						source : undefined,
					...
					var lrd_block_markers = new ol.layer.Vector({
						// title: 'Markers',
					...
					var _block_searchwktpolgonlayer = new ol.layer.Vector({
					...
					var _block_vector_layer = new ol.layer.Vector({
						name : 'my_vectorlayer',
						source : new ol.source.Vector(),
						style : new ol.style.Style({
					...
					var lrd_block_googleLayerHybrid = new ol.layer.Tile(
							{
					...
					var lrd_block_new_de = new ol.layer.Tile({
					...
					var lrd_block_projObj = new ol.proj.Projection({
						// code: 'EPSG:3857',
						code : 'EPSG:2136',
					...
					var lrd_block_view_e = new ol.View({
						// center: ol.proj.fromLonLat([4.8, 47.75]),
						// center: ol.proj.transform([1187433.58822084,
						// 327091.107070208],
						// 'EPSG:4326','EPSG:3857'),
						projection : lrd_block_projObj,
					...
					var lrd_block_map = new ol.Map({
						target : 'lrd-block-map',
						...
						view : lrd_block_view_e
					});

					lrd_block_map.addLayer(lrd_block_googleLayerHybrid);
					lrd_block_map.addLayer(lrd_block_StaticImage);
					lrd_block_map.addLayer(lrd_block_registration_district_dataLayer);
					lrd_block_map.addLayer(lrd_block_spatial_blocked_dataLayer);
					lrd_block_map.addLayer(lrd_block_spatial_deleted_dataLayer);
					
					lrd_block_map.addLayer(lrd_block_grid_lrd_dataLayer);

					// lrd_map.addLayer(beacon_lrd_dataLayer);
					lrd_block_map.addLayer(smd_block_smd_current_dataLayer);
					lrd_block_map.addLayer(lrd_block_lrd_parcels_dataLayer);
					lrd_block_map.addLayer(lrd_block_pvlmd_searchLayer);
					lrd_block_map.addLayer(lrd_block_markers);
					...
					lrd_block_map
							.on(
									...
									function(evt) {
										...
										var viewResolution = lrd_block_map.getView()
												.getResolution();
										var viewProjection = lrd_block_map.getView()
												.getProjection();

										if (lrd_block_click_type === 'DrawClick') {

										}
										if (lrd_block_click_type === 'MapClick') {
											...
											// var viewResolution =
											// (view.getResolution());
											var url = lrd_block_parcel_lrd_dataSource
											...
											var thislayer = lrd_block_lrd_parcels_dataLayer
																		...
																		$
																				.ajax({
																					...
																					success : function(
																						...
																						view
																								.fit(lrd_block_pvlmd_searchLayer
																										.getSource()
																										.getExtent());
																						lrd_map
																								.getView()
					...
					document
							...
							.addEventListener(
									...
									function() {
										...
										view.fit(lrd_block_pvlmd_searchLayer
												.getSource().getExtent());

										lrd_block_map.getView().fit(
												lrd_block_pvlmd_searchLayer
														.getSource()
														.getExtent(), {
													size : map.getSize(),
					...
					$('#lrd_scale_value').change(
							function() {
								...
								var view = lrd_block_map.getView();
					...
					document
							...
							.addEventListener(
									...
									function() {
										...
										lrd_block_StaticImage.setSource(image_source);
										...
										lrd_block_map.getView().fit(new_extent,
												lrd_block_map.getSize());
					...
					document
							...
							.addEventListener(
									...
									function() {
										...
										var extent = lrd_block_pvlmd_searchLayer
												.getSource().getExtent();
										lrd_block_map.getView().fit(extent, {
											size : lrd_block_map.getSize(),
											maxZoom : 16
										})
									});
													...
													.ajax({
														...
														success : function(
															...
															if (json_p !== undefined
																...
																if (lrd_block_pvlmd_searchLayer
																		.getSource() != null) {
																	lrd_block_pvlmd_searchLayer
																			.getSource()
																			.clear();
