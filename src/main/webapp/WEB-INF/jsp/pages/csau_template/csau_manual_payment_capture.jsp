  ...
  <%@ taglib uri = "http://java.sun.com/jsp/jstl/functions" prefix = "fn" %>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Account Manual Payment Capturing Dashboard - ${fullname}</h1>
   ...
   <div class="card">
		        ...
		        <h5 class="card-header" role="tab" id="headingThree">
		            <a class="collapsed d-block" data-toggle="collapse" data-parent="#accordion" href="#collapseacknowledgeofterPayment" aria-expanded="false" aria-controls="collapseThree">
		                <i class="fa fa-chevron-down pull-right"></i> <i class="fas fa-file-alt"></i>Entry For Payment
		            </a>
		        </h5>
		        <div id="collapseacknowledgeofterPayment" class="collapse" role="tabpanel" aria-labelledby="headingThree">
		            <div class="card-body">
				          ...
				          <div class="card mb-3">
								...
								<div class="form-row">
									<div class="col">
										<!-- <button class="btn btn-secondary btn-icon-split float-left " id="btnAddNewUser"  data-toggle="modal" data-target="#createUserModal">
												...
												<input class="form-control" id="txt_ref_number_for_payment_mre" name="txt_ref_number_for_payment_mre" type="text" aria-describedby="nameHelp" placeholder="Enter Reference Number" required="">

									</div>
									<div class="col">
										<button class="btn btn-success btn-icon-split float-right  btn-lg" id="btn_load_bill_details_after_payment_mre" >
				           ...
				           <table class="table table-bordered table-hover table-sm" id="bill_for_payment_list_dataTable_mre" >
