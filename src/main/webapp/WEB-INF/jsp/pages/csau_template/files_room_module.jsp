      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Process batch List</li>
							...
							<div class="form-group">
								<div class="form-row"> 
									<div class="col-8">
										<button class="btn btn-secondary btn-icon-split float-left " id="btn_scm_job_number_search_fr" data-backdrop="static" data-keyboard="false" >
												<span class="icon text-white-50"> <i class="fas fa-search"></i></span><span class="text"> Search </span>
											</button>
              ...
              <div class="mb-3">
                <a href="#" style="text-decoration: underline;" data-id="5" data-toggle="modal" data-target="#incoming_advanced_search_fr">Advanced Filter</a>
              </div>
     ...
     <div class="col-lg-12">
          ...
          <div class="card mb-3">
            <div class="card-header bg-dark text-white">
              ...
              <!-- Application Details -->
              <span class="text h5">Total Applications  <span class="badge text-danger h5">[ ${count} ]</span></span>
           ...
           <table class="table table-bordered data-table" id="tbl_search_for_job_details_datatable" width="100%" cellspacing="0">
              ...
              <thead>
               ...
               <!--   <th style="display:none">Status</th> -->
                 ...
                 <!-- <th>Details</th> -->
                 <th>Client Attention Requitred</th>
