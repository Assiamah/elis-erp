            ...
            <div class="card-body">
				<div class="card mb-3">
				           ...
				           <div class="card-header">
				            ...
				            <div class="card-body">
				               ...
				               <div class="form-group">
								...
								<input placeholder="Email/Phone Number/Job Number" id="client_by_email_phone_search_mb" class="form-control input-sm" data-style="btn-info" type="text" />
							...
							<div class="form-group">
								<div class="form-row">
									...
									<div class="col">
										<button class="btn btn-success btn-icon-split float-right  btn-lg" id="btnFindClientDetailsManualBill"  >
						   ...
						   <div  class="table-responsive">
				           	<table class="table table-bordered table-hover table-sm" id="clientsearchlistManualBills_dataTable" >
