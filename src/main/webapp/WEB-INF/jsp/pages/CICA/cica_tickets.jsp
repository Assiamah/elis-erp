   ...
   <div class="container-fluid">
	<section class="section dashboard">
		                ...
		                <div class=" ">
					         ...
					         <nav>
				                <ol class="breadcrumb">
				                  ...
				                  <li class="breadcrumb-item active">DCU - TICKETS </li>
				                </ol>
			               </nav>
        ...
        <div class="col-lg-12">
          <div class="row">
            <!-- Assigned Cases Card -->
            <div class="col-xl-3 col-md-6" id="tickets_open">
              <div class="card border-left-info shadow h-100 py-2" id="body-bg-1">

                <div class="card-body">
	                  		<h5 class="card-title">Tickets <span>| Open </span></h5>
							...
							<div class="d-flex align-items-center">
								<div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
								 ...
								 <div class="ps-3">	
		                     	 	<h4 id="incoming_count"><c:out value="${open}"></c:out></h4>
								 </div>
		                    </div>
                </div>
            ...
            <!-- Archived Cases Card -->
            <div class="col-xl-3 col-md-6" id="tickets_pending">			 
              <div class="card border-left-warning shadow h-100 py-2" id="body-bg-3">

                <div class="card-body">
                	
                    <h5 class="card-title">Tickets <span>| Pending</span></h5>
	                ...
	                <div class="d-flex align-items-center">
	                    ...
	                    <div class="ps-3">
	                      <h4 id="total_count"><c:out value="${pending}"></c:out></h4>
            ...
            <!-- Unit Cases Card -->
            <div class="col-xl-3 col-md-6" id="tickets_hold">
              <div class="card border-left-danger shadow h-100 py-2" id="body-bg-2">

               <div class="card-body">
               	
                  <h5 class="card-title">Tickets <span>| Hold</span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h4 id="unit_count"><c:out value="${hold}"></c:out></h4>
            ...
            <div class="col-xl-3 col-md-6" id="tickets_resolved">			 
              <div class="card border-left-success shadow h-100 py-2" id="body-bg-4">

                <div class="card-body">
        
                    <h5 class="card-title">Tickets <span>| Resolved</span></h5>
	                ...
	                <div class="d-flex align-items-center">
	                    ...
	                    <div class="ps-3">
	                      <h4 id="total_count"><c:out value="${resolved}"></c:out></h4>
