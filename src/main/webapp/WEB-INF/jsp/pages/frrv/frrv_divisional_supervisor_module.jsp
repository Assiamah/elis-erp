    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="">FRRV Supervisor Management</a>
        </li>
          ...
          <div class="row">
            ...
            <div class="col mb-4">
              <div class="card border-left-primary shadow h-100 py-2"  id="body-dg-1">
                <div class="card-body">
                <a href="#"  class="text-decoration-none btnLoadSupervisor_applicstions_frrv" data-id="1">
            ...
            <div class="col mb-4">
              <div class="card border-left-success shadow h-100 py-2"  id="body-dg-2">
                <div class="card-body">
                 <a href="#"  class="text-decoration-none btnLoadSupervisor_applicstions_frrv" data-id="2">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
            ...
            <div class="col mb-4">
              <div class="card border-left-info shadow h-100 py-2"  id="body-dg-3">
                <div class="card-body">
                <a href="#"  class="text-decoration-none btnLoadSupervisor_applicstions_frrv" data-id="3"> 
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
            ...
            <!-- Pending Requests Card Example -->
             <div class="col-xl-3 col-md-6 mb-4" >
              <div class="card border-left-warning shadow h-100 py-2" id="body-dg-4">
                <div class="card-body" >
                <a href="#"  class="text-decoration-none btnLoadSupervisor_applicstions_frrv" data-id="4">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
          ...
          <div class="card mb-3">
           ...
           <div class="row">
                ...
                <div class="form-row mt-2">
	            	<div class="col">
	            	<!-- <label for="search_btn">&nbsp;</label>  -->
	            		<button class="btn btn-primary btn-icon-split w-100"  id="btnAddAlltoBatchlistforsupervisor">
           ...
           <table class="table table-bordered table-hover" id="job_casemgtdetailsdataTable__supervisor_frrv" width="100%" cellspacing="0">
