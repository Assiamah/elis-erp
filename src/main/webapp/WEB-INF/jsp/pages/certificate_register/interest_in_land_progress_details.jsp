									...
									<div class="col-md-6">
										...
										<div class="form-group">
											<label for="">Surveyors Number</label> <input type="text"
												...
												placeholder="Surveyors Number"  readonly  value="${surveyor_number}"
											>
										</div>
										<div class="form-group">
											<label for="">Regional Number</label> <input type="text"
												class="form-control" id="fe_regional_number"
												placeholder="Regional Number" readonly  value="${regional_number}"
											>
										</div>
										...
										<div class="form-group">
											...
											<div class="input-group">
										        ...
										        <input value="${size_of_land}" step="0.111" type="text" readonly class="form-control" id="fe_land_size" placeholder="size in Acreage" aria-describedby="inputGroupPrepend" >
										...
										<div class="form-group">
											...
											<label for="">Nature of Instrument</label> <input type="text"
												class="form-control" id="fe_nature_of_instrument"
												   value="${nature_of_instrument}" readonly
											>
										</div>
							         ...
							         <div class="form-group">
										...
										<div class="form-group">
											<label for="">Type of Interest</label> <select value="${type_of_interest}"
												class="form-control" id="fe_type_of_interest" required readonly
											>
										...
										<div class="form-group">
											...
											<select class="form-control" id="fe_consideration_currency" readonly required>
										...
										<div class="form-group">
											<label for="">Date of Document </label> <input type="date"
												...
												required value="${date_of_document}" readonly
											>
										</div>
										<div class="form-group">
											<label for="">Commencement Date</label> <input type="date"
												class="form-control " id ="fe_commencement_date"
												placeholder="" required value="${commencement_date}" readonly
											>
										</div>
										...
										<div class="form-group">
											<label for="">Registration Date</label> <input type="date"
												...
												placeholder="" required value="${date_of_registration}" readonly
											>
										</div>
									...
									<div class="col-md-6">
										...
										<div class="form-group">
											<label for="">Locality</label> <input type="text" class="form-control"
												id="fe_locality" required  value="${locality}" readonly
											>
										...
										<div class="form-group">
											<label for="">District</label> <input type="text" class="form-control"
												id="fe_district" required  value="${district}" readonly
											>
										...
										<div class="form-group">
											<label for="">Region</label> <input type="text" class="form-control"
												id="fe_region" required  value="${region}" readonly
											>
										...
										<div class="form-group">
											<label for="">Option to Renew</label> <input type="text"
												...
												required value="${renewal_term}" readonly
											>
										</div>
										<!-- <div class="form-group">
										...
										<input type="hidden"
												...
												placeholder="Stool/Family Name" required readonly
											>
										...
										<div class="form-group">
											...
											<label for="">Consideration Fee</label> 
											  <div class="input-group">
										        ...
										        <input value="${consideration_fee}" type="number" class="form-control" id="fe_consideration_fee" readonly  placeholder="amount in GHS" aria-describedby="inputGroupPrepend" required>
										        <div class="invalid-feedback">
										...
										<div class="form-group">
											...
											<div class="input-group">
										        ...
										        <input value="${annual_rent}" type="number" class="form-control" id="fe_annual_rent" readonly placeholder="amount in GHS" aria-describedby="inputGroupPrepend" required>
										        <div class="invalid-feedback">
										          Please enter Rent.
										        </div>
										      </div>
										...
										<div class="form-group">
											<label for="inputEmail4">Transaction Number</label> <input
												...
												placeholder="Case number" required readonly value="${transaction_number}" readonly
											>
										</div>
										...
										<div class="form-group">
											<label for="">File Number</label> <input type="text"
													class="form-control" id="fe_file_number"
													   value="${case_file_number}" readonly
												>
									    </div>
										...
										<div class="form-group">
											<label for="">Certificate Type</label> <input type="text"
													class="form-control" id="fe_certificate_type"
													   value="${certificate_type}" readonly
												>
										</div>
