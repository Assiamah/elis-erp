								...
								<div class="form-row">
									...
									<div class="col-md-12">
										...
										<input type="hidden" id="request_type" name="request_type"
																						value="request_to_generate_case_letter"
																					>
											<div class="form-group">
												
												
									<div class="form-row">
									  <textarea id="lc_search_report_summary_details_final" name="lc_search_report_summary_details_final" class="form-control col-sm-12" required rows=7  style="padding:50px !important;"></textarea> 
