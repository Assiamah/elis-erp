    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="">TPP Supervisor Management</a>
        </li>
          ...
          <div class="row">
            ...
            <div class="col-xl-3 mb-4">
              <div class="card border-left-primary shadow h-100 py-2"  id="body-dg-1">
                <div class="card-body">
                <a href="#"  class="text-decoration-none btnLoadSupervisor_applicstions_Tpp" data-id="1">
            ...
            <div class="col-xl-3 mb-4">
              <div class="card border-left-info shadow h-100 py-2"  id="body-dg-3">
                <div class="card-body">
                <a href="#"  class="text-decoration-none btnLoadSupervisor_applicstions_Tpp" data-id="4"> 
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
             ...
             <div class="col-xl-3 col-md-6 mb-4" >
              <div class="card border-left-warning shadow h-100 py-2" id="body-dg-4">
                <div class="card-body" >
                <a href="#"  class="text-decoration-none btnLoadSupervisor_applicstions_Tpp" data-id="6">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Completed From Staff</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800" id="number-text-4">${completed}</div>
                    </div>
                    <div class="col-auto">
            ...
            <!-- Pending Requests Card Example -->
             <div class="col-xl-3 col-md-6 mb-4" >
              <div class="card border-left-warning shadow h-100 py-2" id="body-dg-4">
                <div class="card-body" >
                <a href="#"  class="text-decoration-none btnLoadSupervisor_applicstions_Tpp" data-id="3">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Pending Title Plan</div>
            ...
            <%-- <div class="col-xl-2 mb-4">
              <div class="card border-left-success shadow h-100 py-2"  id="body-dg-2">
                <div class="card-body">
                 <a href="#"  class="text-decoration-none btnLoadSupervisor_applicstions_Tpp" data-id="5">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Waiting for Signing</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"  id="number-text-2">${awaiting_signing}</div>
                    </div>
                    <div class="col-auto">
           ...
           <%--  <div class="col-xl-2 mb-4">
              <div class="card border-left-success shadow h-100 py-2"  id="body-dg-2">
                <div class="card-body">
                 <a href="#"  class="text-decoration-none btnLoadSupervisor_applicstions_Tpp" data-id="7">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Waiting for Sealing and Scanning</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"  id="number-text-2">${awaiting_scanning}</div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-clipboard-list fa-2x text-gray-300"></i>
                    </div>
          ...
          <div class="card mb-3">
           ...
           <div class="row">
            	<div class="col-sm-8 form-row">
	            	...
	            	<div class="col">
	            	<!-- <label for="search_btn">&nbsp;</label>  -->
	            		<button class="btn btn-primary btn-icon-split"  id="btnAddAlltoBatchlistforsupervisor">
           ...
           <table class="table table-bordered table-hover" id="job_casemgtdetailsdataTable__supervisor_tpp" width="100%" cellspacing="0">
