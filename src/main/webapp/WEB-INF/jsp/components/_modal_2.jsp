         ...
         <div class="modal-body">
            ...
            <div class="card mb-4 shadow-sm border">
               <div class="card-body">
                  <div class="row align-items-center mb-3">
                     <div class="col-md-6">
                        ...
                        <div class="btn-group w-100" role="group" aria-label="File type selection">
                           ...
                           <input type="radio" class="btn-check" name="file_type_radio" id="file_type_cross_unit" autocomplete="off" value="Cross-Unit">
                           <label class="btn btn-outline-primary" for="file_type_cross_unit">
                  ...
                  <div class="batch-section bg-primary-transparent border rounded p-3 mb-3" id="cross-unit-file-section" style="display: none;">
                     <h6 class="fw-semibold mb-3 text-primary">
                        <i class="ri-swap-fill me-2"></i>Batching to a Different Unit/Division
                     </h6>
                     <div class="row g-3">
                        <div class="col-md-4">
                           <label for="cross_file_unit_division_to_send_to" class="form-label fw-medium">
                              Division <span class="text-danger">*</span>
                           </label>
                           <select id="cross_file_unit_division_to_send_to" data-trigger class="form-select">
                              <option value="" selected disabled>Select Division</option>
                              <option value="LVD">LVD</option>
                              <option value="LRD">LRD</option>
                              <option value="PVLMD">PVLMD</option>
                        ...
                        <div class="col-md-4">
                           <label for="cross_file_unit_to_send_to" class="form-label fw-medium">
                              Unit <span class="text-danger">*</span>
                              <small class="text-muted ms-1" id="cross-file_unit-count">(0 units)</small>
                           </label>
                           <select class="form-select" id="cross_file_unit_to_send_to" disabled>
                              <option value="" selected disabled>Select a unit</option>
                           </select>
                           <div class="form-text"><i class="ri-information-line me-1"></i>Select a unit from the chosen division</div>
                        </div>
                        <div class="col-md-4">
                           <label for="cross_file_unit_user_to_send_to" class="form-label fw-medium">
                              Officer <span class="text-danger">*</span>
                              <small class="text-muted ms-1" id="cross-file_user-count">(0 users)</small>
                           </label>
                           <select class="form-select" id="cross_file_unit_user_to_send_to" disabled>
                              <option value="" selected disabled>Select a user</option>
                           </select>
