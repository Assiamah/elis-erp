														...
														$(json_p.data)
																.each(
																		function() {
																			...
																			table
																					.append("<tr><td>"
																							+ (this.doc_number == null ? '--' : this.doc_number)
																							+ "</td><td>"
																							+ (this.instrument_type == null ? '--' : this.instrument_type)
																							+ "</td><td>"
																							+ (this.instrument_date == null ? '--' : this.instrument_date)
																							+ "</td><td>"
																							+ (this.consent_date == null ? '--' : this.consent_date)
																							+ "</td><td>"
																							+ (this.party1_plaintiff == null ? '--' : this.party1_plaintiff)
																							+ "</td><td>"
																							+ (this.party2_defendant == null ? '--' : this.party2_defendant)
																							+ "</td><td>"
																							+ (this.reference_number == null ? '--' : this.reference_number)
																							+ "</td><td>"
																							+ (this.remarks == null ? '--' : this.remarks)
																							+ "</td>"

																							+ '<td><p data-placement="top" data-toggle="tooltip" title="Details"><button class="btn btn-info btn-icon-split" data-bs-toggle="modal" href="#addpvlmdtransactionlong_t" data-target-id="'
																							+ this.t_id
