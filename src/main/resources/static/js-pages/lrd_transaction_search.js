														...
														$(json_p.data)
																.each(
																		function() {
																			...
																			table
																					.append("<tr><td>"
																							+ (this.applicant_name == null ? '--' : this.applicant_name)
																							+ "</td><td>"
																							+ (this.grantor_name == null ? '--' : this.grantor_name)
																							+ "</td><td>"
																							+ (this.certicate_number == null ? '--' : this.certicate_number)
																							+ "</td><td>"
																							+ (this.nature_of_instument == null ? '--' : this.nature_of_instument)
																							+ "</td>"

																							+ '<td class="text-center"><p data-placement="top" data-toggle="tooltip" title="Details"><button class="btn btn-info btn-icon-split" data-dismiss="modal" data-bs-toggle="modal" href="#addlrdtransaction" data-target-id="'
																							+ this.gid
