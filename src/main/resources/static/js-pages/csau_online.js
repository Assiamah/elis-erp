																...
																function() {
																	...
																	table
																			.append("<tr><td>"
																					...
																					+ '<td><button title="Create New Bill" class="btn btn-secondary btn-icon-split btn-sm" data-toggle="modal" data-target="#generateManualBillModal" '
																					+ 'data-pu_name="'
																					+ this.first_name
																					+ ' '
																					+ this.other_names
    ...
    switch(serviceName) {
        ...
        default:
            ...
            break;
					...
					$('#btn_lja_search_for_job_number_details')
							.on(
									'click',
									function(e) {
										var job_number = $("#lja_job_number")
												.val();
