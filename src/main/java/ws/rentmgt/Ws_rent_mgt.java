...
public class Ws_rent_mgt {
...

	{
		...
		try {
			Client client = Client.create();
			WebResource webResource = client
					.resource(web_service_url + "rent_mgt_service/select_rt_govt_estatesg_list");
...

	{
		...
		try {
			Client client = Client.create();
			WebResource webResource = client
					.resource(web_service_url + "rent_mgt_service/select_rt_nature_of_instrument_list");
			// ClientResponse response =
			// webResource.accept("text/plain").header("api-key",ws_url_config.get_service_api_key()).post(ClientResponse.class,job_number);
			ClientResponse response = webResource.accept("application/json")
					.header("x-api-key", web_service_api_key).post(ClientResponse.class, "test");
...

	{
		...
		try {
			Client client = Client.create();
			WebResource webResource = client
					.resource(web_service_url + "rent_mgt_service/select_rt_nature_of_development_list");
			// ClientResponse response =
			// webResource.accept("text/plain").header("api-key",ws_url_config.get_service_api_key()).post(ClientResponse.class,job_number);
			ClientResponse response = webResource.accept("application/json")
					.header("x-api-key", web_service_api_key).post(ClientResponse.class, "test");
...

	{
		...
		try {
			Client client = Client.create();
			WebResource webResource = client
					.resource(web_service_url + "rent_mgt_service/select_rt_user_category_list");
			// ClientResponse response =
			// webResource.accept("text/plain").header("api-key",ws_url_config.get_service_api_key()).post(ClientResponse.class,job_number);
			ClientResponse response = webResource.accept("application/json")
					.header("x-api-key", web_service_api_key).post(ClientResponse.class, "test");
	...
	public String select_rent_dashboard_stats(String web_service_url, String web_service_api_key,
			String estate_code)

	{
		...
		try {
			...
			WebResource webResource = client.resource(
					web_service_url + "rent_mgt_service/select_rent_dashboard_stats");
			// ClientResponse response =
			// webResource.accept("text/plain").header("api-key",ws_url_config.get_service_api_key()).post(ClientResponse.class,job_number);
			ClientResponse response = webResource.accept("application/json")
	...
	public String select_ground_rent_lessee_information_update_by_region(String web_service_url, String web_service_api_key,
			String estate_code)

	{
		...
		try {
			Client client = Client.create();
			WebResource webResource = client.resource(
					web_service_url + "rent_mgt_service/select_ground_rent_lessee_information_update_by_region");
			// ClientResponse response =
			// webResource.accept("text/plain").header("api-key",ws_url_config.get_service_api_key()).post(ClientResponse.class,job_number);
			ClientResponse response = webResource.accept("application/json")
					.header("x-api-key", web_service_api_key).post(ClientResponse.class, estate_code);
	...
	public String review_ground_rent_lessee_information_update(String web_service_url, String web_service_api_key,
			String review_data) {
		String output = "Data Not Received";
		try {
			Client client = Client.create();
			WebResource webResource = client.resource(
					web_service_url + "rent_mgt_service/review_ground_rent_lessee_information_update");
			ClientResponse response = webResource.accept("application/json")
					.header("x-api-key", web_service_api_key).post(ClientResponse.class, review_data);
			if (response.getStatus() != 200) {
				throw new RuntimeException("Failed : HTTP error code : " + response.getStatus());
			}
			output = response.getEntity(String.class);
...
public String select_rent_leasee_details_by_account_number(String web_service_url, String web_service_api_key,
	...
	public String select_rent_reporting_dashboard_stats(String web_service_url, String web_service_api_key,
			String estate_code)

	{
		...
		try {
			Client client = Client.create();
			WebResource webResource = client.resource(
					web_service_url + "rent_mgt_service/select_rent_reporting_dashboard_stats");
			// ClientResponse response =
			// webResource.accept("text/plain").header("api-key",ws_url_config.get_service_api_key()).post(ClientResponse.class,job_number);
			ClientResponse response = webResource.accept("application/json")
					.header("x-api-key", web_service_api_key).post(ClientResponse.class, estate_code);
