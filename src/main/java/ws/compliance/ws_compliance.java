...
public class ws_compliance {
	...
	public String report_dashboard_all_get(String report_web_service_url, String web_service_api_key) {
		...
		try {
			...
			WebResource webResource = client
					.resource(report_web_service_url + "compliance_service/report_dashboard_all");
	...
	public String report_dashboard_created_today_post(String report_web_service_url, String web_service_api_key,
		...
		try {
			...
			WebResource webResource = client.resource(
					report_web_service_url + "compliance_service/report_dashboard_created_today");
			ClientResponse response = webResource.accept("application/json")
					.header("x-api-key", web_service_api_key).post(ClientResponse.class, json_request);
			if (response.getStatus() != 200) {
				throw new RuntimeException("Failed : HTTP error code : " + response.getStatus());
	...
	public String report_dashboard_created_month_post(String report_web_service_url, String web_service_api_key,
		...
		try {
			Client client = Client.create();
			WebResource webResource = client.resource(
					report_web_service_url + "compliance_service/report_dashboard_created_month");
			ClientResponse response = webResource.accept("application/json")
					.header("x-api-key", web_service_api_key).post(ClientResponse.class, json_request);
			if (response.getStatus() != 200) {
				throw new RuntimeException("Failed : HTTP error code : " + response.getStatus());
	...
	public String report_dashboard_completed_today_post(String report_web_service_url, String web_service_api_key,
		...
		try {
			Client client = Client.create();
			WebResource webResource = client.resource(
					report_web_service_url + "compliance_service/report_dashboard_completed_today");
			ClientResponse response = webResource.accept("application/json")
					.header("x-api-key", web_service_api_key).post(ClientResponse.class, json_request);
			if (response.getStatus() != 200) {
				throw new RuntimeException("Failed : HTTP error code : " + response.getStatus());
	...
	public String report_dashboard_completed_month_post(String report_web_service_url, String web_service_api_key,
		...
		try {
			Client client = Client.create();
			WebResource webResource = client.resource(
					report_web_service_url + "compliance_service/report_dashboard_completed_month");
			ClientResponse response = webResource.accept("application/json")
					.header("x-api-key", web_service_api_key).post(ClientResponse.class, json_request);
			if (response.getStatus() != 200) {
				throw new RuntimeException("Failed : HTTP error code : " + response.getStatus());
	...
	public String report_dashboard_units_with_apps_past_due_year_post(String report_web_service_url,
		...
		try {
			...
			WebResource webResource = client.resource(
					report_web_service_url + "compliance_service/report_dashboard_unit_within_division");
			ClientResponse response = webResource.accept("application/json")
					.header("x-api-key", web_service_api_key).post(ClientResponse.class, json_request);
			if (response.getStatus() != 200) {
				throw new RuntimeException("Failed : HTTP error code : " + response.getStatus());
	...
	public String report_dashboard_officers_within_units_with_apps_past_due_year_post(String report_web_service_url,
		...
		try {
			...
			WebResource webResource = client.resource(
					report_web_service_url + "compliance_service/report_dashboard_unit_within_each_unit_v5");
			ClientResponse response = webResource.accept("application/json")
					.header("x-api-key", web_service_api_key).post(ClientResponse.class, json_request);
			if (response.getStatus() != 200) {
				throw new RuntimeException("Failed : HTTP error code : " + response.getStatus());
	...
	public String report_dashboard_applications_with_officers_that_are_apps_past_due_year_post(String report_web_service_url,
		...
		try {
			...
			WebResource webResource = client.resource(
					report_web_service_url + "compliance_service/report_dashboard_unit_for_each_staff_v5");
			ClientResponse response = webResource.accept("application/json")
					.header("x-api-key", web_service_api_key).post(ClientResponse.class, json_request);
			if (response.getStatus() != 200) {
				throw new RuntimeException("Failed : HTTP error code : " + response.getStatus());
	...
	public String select_reminder_apps_from_complaince_notice_by_unit(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
		...
		try {
			...
			WebResource webResource = client.resource(
					report_web_service_url + "compliance_service/select_reminder_apps_from_complaince_notice_by_unit");
			ClientResponse response = webResource.accept("application/json")
					.header("x-api-key", web_service_api_key).post(ClientResponse.class, json_request);
			if (response.getStatus() != 200) {
				throw new RuntimeException("Failed : HTTP error code : " + response.getStatus());
	...
	public String select_warning_apps_from_complaince_notice_by_unit(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
		...
		try {
			...
			WebResource webResource = client.resource(
					report_web_service_url + "compliance_service/select_warning_apps_from_complaince_notice_by_unit");
			ClientResponse response = webResource.accept("application/json")
					.header("x-api-key", web_service_api_key).post(ClientResponse.class, json_request);
			if (response.getStatus() != 200) {
				throw new RuntimeException("Failed : HTTP error code : " + response.getStatus());
	...
	public String send_compliance_focal_person_message(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
	...
	public String select_update_compliance_notice_to_active(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
	...
	public String select_compliance_application_notice_by_unit(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
	...
	public String select_compliance_application_notice_count_per_region(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
	...
	public String update_compliance_application_notice(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
	...
	public String select_responses_on_compliance_application_notice(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
	...
	public String compliance_executive_dashboard(String report_web_service_url, String web_service_api_key) {
		String output = "Data Not Received";

		try {
			Client client = Client.create();
			WebResource webResource = client
					.resource(report_web_service_url + "compliance_executive/compliance_executive_dashboard");
			ClientResponse response = webResource.accept("application/json")
	...
	public String compliance_executive_dashboard1(String report_web_service_url, String web_service_api_key) {
		String output = "Data Not Received";

		try {
			Client client = Client.create();
			WebResource webResource = client
					.resource(report_web_service_url + "compliance_executive/compliance_executive_dashboard1");
			ClientResponse response = webResource.accept("application/json")
					.header("x-api-key", web_service_api_key).post(ClientResponse.class);
			if (response.getStatus() != 200) {
				throw new RuntimeException("Failed : HTTP error code : " + response.getStatus());
	...
	public String corporate_applications_report_dashboard_created_year_by_divisio(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
	...
	public String corporate_applications_report_dashboard_created_year_by_service(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
	...
	public String corporate_applications_report_dashboard_completed_year_by_divis(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
	...
	public String corporate_applications_report_dashboard_completed_year_by_servi(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
	...
	public String corporate_applications_report_dashboard_created_completed_year(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
	...
	public String corporate_applications_report_dashboard_created_completed(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
	...
	public String corporate_applications_report_dashboard_unit_within_division(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
	...
	public String corporate_applications_report_dashboard_unit_within_each_unit(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
	...
	public String corporate_applications_report_dashboard_unit_for_each_staff(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
	...
	public String corporate_applications_report_dashboard_apps_past_due_officer(String report_web_service_url, String web_service_api_key,
	String json_request) {
		String output = "Data Not Received";
		...
		public String corporate_applications_report_dashboard_apps_past_due_appss(String report_web_service_url, String web_service_api_key,
			String json_request) {
		String output = "Data Not Received";
