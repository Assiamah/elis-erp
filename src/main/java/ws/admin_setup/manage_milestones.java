...
@Controller
public class manage_milestones extends HttpServlet {
	private static final long serialVersionUID = 1L;

	@Autowired
	private Ws_url_config cls_url_config;

	@RequestMapping("/manage_milestones")
	@PostMapping
	public String manage_milestones(HttpSession session, Model model, HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			return "/setup/manage_milestone.jsp";
