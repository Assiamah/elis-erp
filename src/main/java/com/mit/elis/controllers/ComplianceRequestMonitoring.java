...
@Controller
public class ComplianceRequestMonitoring {
	...
	@RequestMapping("/compliance_request_monitoring")
	@GetMapping
	public String compliance_req_monitoring(HttpSession session, Model model, HttpServletRequest request, HttpServletResponse response) {
