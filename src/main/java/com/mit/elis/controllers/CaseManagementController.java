...
String digital_workflow_steps = case_obj.get("digital_workflow_steps").toString();
	...
	@RequestMapping("/request_application_progress_details_ai_short")
	@PostMapping
	public String request_application_progress_details_ai_short(HttpSession session, Model model, HttpServletRequest request,
			HttpServletResponse response) {
		// TODO Auto-generated method stub
		// doGet(request, response);
		...
		try {
			...
			obj.put("job_purpose", job_purpose);
			obj.put("rq_id", rq_id);
			obj.put("section", "initial");
			String batchlistdivison = obj.toString();
			// //System.out.println(batchlistdivison);
		
			if ("GeneralWorkRequest".equals(review_type)) {
	         web_service_response = vas_cl.select_review_digital_workflow_short(cls_url_config.getWeb_service_url_ser(),
						cls_url_config.getWeb_service_url_ser_api_key(),
					batchlistdivison);
...
String digital_workflow_steps = case_obj.get("digital_workflow_steps").toString();
			...
			//	//System.out.println(case_obj.get("parcel_wkt").toString());
				...
				// //System.out.println(business_process_sub_name);
						ShortReviewSectionController.register(session, request);
						model.addAttribute("content", "../pages/client_application/_application_review_details_ai_short_e.jsp"); return "layouts/app";
...
request.setAttribute("rq_id",rq_id);
	...
	@RequestMapping("/request_application_progress_details_advance_ai")
	@PostMapping
	public String request_application_progress_details_advance_as(HttpSession session, Model model, HttpServletRequest request,
			HttpServletResponse response) {
		// TODO Auto-generated method stub
		// doGet(request, response);
		if (request.getRequestedSessionId() != null && !request.isRequestedSessionIdValid()) {
...
request.setAttribute("rq_id",rq_id);
				...
				model.addAttribute("content", "../pages/client_application/_request_application_progress_details_advance_ai.jsp"); 
