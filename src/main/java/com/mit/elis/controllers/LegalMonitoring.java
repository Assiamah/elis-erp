...
public class LegalMonitoring {
	...
	@RequestMapping("/legal_monitoring_app")
	@GetMapping
	public String legal_applications_monitoring(HttpSession session, Model model, HttpServletRequest request, HttpServletResponse response) {
	...
	//  String web_service_response = cls_backoffice_monitoring.monitoring_backoffice_csau(cls_url_config.getWeb_service_url_ser(), cls_url_config.getWeb_service_url_ser_api_key());
           ...
           //System.out.println(userlevel);
           		...
           		model.addAttribute("content", "../pages/client_application/legal_application_monitoring.jsp"); return "layouts/app";
