...
@RestController
public class document_upload_public {
	@Autowired
	private Ws_url_config cls_url_config;

	private final RestTemplate restTemplate = new RestTemplate();

	@RequestMapping("/document_upload_public")
	@PostMapping
	public String document_upload_public(HttpSession session, Model model, HttpServletRequest request, HttpServletResponse response)
		...
		String savePath = cls_url_config.getPublic_docs_upload_location();
	...
	@RequestMapping("/document_upload_public_new")
	@PostMapping
	public String documentUploadPublicNew(HttpSession session, Model model, HttpServletRequest request, HttpServletResponse response, 
	...
	@RequestMapping("/document_upload_multiple_public_new")
    @PostMapping
	...
	@RequestMapping("/scanned_site_plan_upload")
	@PostMapping
	public String scanned_site_plan_upload(HttpSession session, Model model, HttpServletRequest request,
			HttpServletResponse response)
			throws IOException, ServletException {
		// TODO Auto-generated method stub
