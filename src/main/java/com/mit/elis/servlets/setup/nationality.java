...
import ws.setup.Ws_nationality;
    ...
    public String doPost(HttpSession session, Model model, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (request_type.equals("update")) {
                String religion_id = request.getParameter("nationality_id");
                String religion_name = request.getParameter("nationality_name");

                obj.put("nationality_id", religion_id);
                obj.put("nationality_name", religion_name);
